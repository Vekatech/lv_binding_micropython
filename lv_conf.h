...
#else       /*LV_MEM_CUSTOM*/
    #define LV_MEM_CUSTOM_INCLUDE "include/lv_mp_mem_custom_include.h" //<stdlib.h>   /*Header for the dynamic memory function*/
    #define LV_MEM_CUSTOM_ALLOC   m_malloc //malloc
    #define LV_MEM_CUSTOM_FREE    m_free //free
    #define LV_MEM_CUSTOM_REALLOC m_realloc //realloc
#endif     /*LV_MEM_CUSTOM*/
